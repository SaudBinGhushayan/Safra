...
export default async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target =COMPILER_NAMES.server , appDir , middlewareMatchers  }) {
    ...
    let webpackConfig = {
        ...
        plugins: [
            ...
            isClient && new ReactLoadablePlugin({
                ...
                pagesDir,
                runtimeAsset: true ? `server/${MIDDLEWARE_REACT_LOADABLE_MANIFEST}.js` : undefined,
                dev
            }),
