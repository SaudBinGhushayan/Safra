        ...
        const buildResult = await nextBuildSpan.traceAsyncFn(async ()=>{
                        ...
                        if (!(0, _utils1).isReservedPage(page)) {
                            try {
                                ...
                                if (pageRuntime === _constants.SERVER_RUNTIME.edge) {
                                    const manifest = require((0, _path).join(distDir, _constants1.SERVER_DIRECTORY, _constants1.MIDDLEWARE_MANIFEST));
            ...
            if (config.output === "standalone") {
                await nextBuildSpan.traceChild("copy-traced-files").traceAsyncFn(async ()=>{
                    await (0, _utils1).copyTracedFiles(dir, distDir, pageKeys.pages, outputFileTracingRoot, requiredServerFiles.config, middlewareManifest);
                });
            }
