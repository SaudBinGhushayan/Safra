...
function setHttpClientAndAgentOptions(config) {
    ...
    if (isAboveNodejs16) {
        ...
        if (((ref1 = config.experimental) == null ? void 0 : ref1.enableUndici) && isAboveNodejs18) {
            ...
            var ref2, ref3;
            global.__NEXT_USE_UNDICI = ((ref2 = config.experimental) == null ? void 0 : ref2.appDir) ? true : (ref3 = config.experimental) == null ? void 0 : ref3.enableUndici;
        }
    ...
    global.__NEXT_HTTP_AGENT_OPTIONS = config.httpAgentOptions;
    global.__NEXT_HTTP_AGENT = new _http.Agent(config.httpAgentOptions);
    global.__NEXT_HTTPS_AGENT = new _https.Agent(config.httpAgentOptions);
}
